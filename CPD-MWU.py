...
#			    CPD-MWU
#
# Dynamic sketching to accelerate Canonical Polyadic Decomposition
# (CPD) of large dense tensors using Multiplicative Weight Updates
# (MWU) to weigh different sketching rate arm options. Sketching
# rate is selected at each iteration using weighted sampling.
#
